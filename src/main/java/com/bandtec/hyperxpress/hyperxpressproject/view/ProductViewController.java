...
public class ProductViewController {
	...
	public ProdutoVendedorDTO getProductVendedor(Long idUsuario) {
		...
		List<Produto> produtos = produtoRepository.findByUsuarioProduto_IdAndStatusProduto(idUsuario, StatusProduto.ATIVO);
		...
		produtoVendedorDTO.setFinalizados(produtoRepository.countByUsuarioProduto_IdAndStatusProduto(idUsuario, StatusProduto.VENDIDO));
		...
		produtoVendedorDTO.setProdutos(produtos
				.stream().map(p -> {
					...
					produtoDetalheVendedorDTO.setNomeUsuario(usuario.getNome());
